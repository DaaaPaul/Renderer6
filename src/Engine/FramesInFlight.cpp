...
FramesInFlight::FramesInFlight(uint32_t frames_in_flight, uint32_t frame_submit_count) :
	cmd_pool{ Vulkan::create_cmd_pool(VK_COMMAND_POOL_CREATE_TRANSIENT_BIT | VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT, PhysicalDevice::g_graphics_family_index[0]) },
